...
const Home = () => {
  ...
  return (
    <div
      name='home'
      className='bg-[#0a192f] min-h-screen flex py-20 md:flex-row flex-col items-center'
    >
      <motion.div
        ...
        className='shadow-md shadow-violet-400 flex-1 bg-gradient-to-tr from-violet-600 rounded-2xl pl-4 w-[90%] md:ml-40 '
      >
